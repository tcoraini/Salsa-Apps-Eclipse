...
public class Trap extends UniversalActor  {
	public static void main(String args[]) {
		...
		Trap instance = (Trap)new Trap(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Trap(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Trap.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Trap(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Trap.getReferenceByLocation(new UAL(ual)); }
	public Trap(boolean o, UAN __uan)	{ super(false,__uan); }
	public Trap(boolean o, UAL __ual)	{ super(false,__ual); }
	public Trap(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Trap(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Trap(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Trap()		{  }
	public Trap(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.trap.Trap", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Trap)actorReference).setUAL(getUAL());
			((Trap)actorReference).setUAN(getUAN());
			self = new Trap(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public void act(String args[]) {
			...
			if (argc>=1) {a = Double.valueOf(args[0]).doubleValue();
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "endTimer", _arguments, token_2_1, null );
					__messages.add( message );
				}
			}
		}
		public double[][] DistributeWork() {
			Double h = new Double((b-a)/n);
			Integer local_n = new Integer((int)(n/noActors));
			Double local_a;
			Double local_b;
			TrapWorker[] workers = new TrapWorker[noActors];
			for (int i = 0; i<noActors; i++){
				workers[i] = ((TrapWorker)new TrapWorker(this).construct());
			}
			...
			for (int i = 0; i<noActors; i++){
				{
					...
					{
						Object _arguments[] = { "Sending actor "+"uan://"+nameServer+":3030/a"+i+" to "+"rmsp://"+theaters.get(i%theaters.size())+"/a"+i };
						Message message = new Message( self, standardOutput, "println", _arguments, null, null );
						__messages.add( message );
					}
				}
				workers[i] = ((TrapWorker)new TrapWorker(new UAN("uan://"+nameServer+":3030/a"+i), new UAL("rmsp://"+theaters.get(i%theaters.size())+"/a"+i),this).construct());
			}
			{
		...
		public void endTimer() {
			...
			{
				// standardOutput<-println("Running time for Trapezoidal"+" approximation is "+runningTime+" ms.")
				{
					Object _arguments[] = { "Running time for Trapezoidal"+" approximation is "+runningTime+" ms." };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		...
		public void displayResults(Double result) {
			{
				...
				{
					Object _arguments[] = { "With n = "+n+" trapezoids, our estimate of the integral on ("+a+","+b+") ="+result.doubleValue()+"with error "+(result.doubleValue()-1.0e0) };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
