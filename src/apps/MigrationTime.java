...
public class MigrationTime extends UniversalActor  {
	public static void main(String args[]) {
		...
		MigrationTime instance = (MigrationTime)new MigrationTime(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new MigrationTime(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return MigrationTime.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new MigrationTime(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return MigrationTime.getReferenceByLocation(new UAL(ual)); }
	public MigrationTime(boolean o, UAN __uan)	{ super(false,__uan); }
	public MigrationTime(boolean o, UAL __ual)	{ super(false,__ual); }
	public MigrationTime(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public MigrationTime(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public MigrationTime(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public MigrationTime()		{  }
	public MigrationTime(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "apps.MigrationTime", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public MigrationTime self;
		public void updateSelf(ActorReference actorReference) {
			((MigrationTime)actorReference).setUAL(getUAL());
			((MigrationTime)actorReference).setUAN(getUAN());
			self = new MigrationTime(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "apps.MigrationTime$State" );
		...
		public void act(String[] args) {
			try {
			...
			catch (MalformedUANException e) {
				{
					...
					{
						Object _arguments[] = { "Error creating UAN: "+e };
